/*===============================================================
--  Caetano Traina Júnior -- abril de 2025 ----------- ==========
--    1-Criar o ESQUEMA para A base de dados sobre Formula 1   ==
--    2-Executar a carga da base de dados sobre Formula 1      ==
--  Tempo aproximado de execução: 13 secs. (Dell-Sol)          ==
---------------------------------------------------------------==

As tabelas sobre a Fórmula 1 foram obtidas no site do repositório Ergast de:    http://ergast.com/mrd/db/

As tabelas Airports, Countries foram obtidas de    https://ourairports.com/data/    

A tabela GeoCities15K foi obtida de https://download.geonames.org/export/dump/

Este script define e carrega as tabelas, cada uma de seu respectivo arquivo em formato ".csv" ou ".tsv".
Para executar o script, é necessário ter as tabelas já carregadas em um diretório do disco local,
 indicado na variável DirLocal, que deve ser definida na linha 43
*/
